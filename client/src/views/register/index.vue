<template>
  <div class="lowin  lowin-blue">
      ...
      <div class="lowin-box lowin-register">
        <div class="lowin-box-inner">
          <el-form ref="loginForm" :model="loginForm" :rules="rules">
            <p>学之思开源考试系统</p>
            <el-form-item class="lowin-group" label="用户名" prop="userName"> 
              <!-- <label>用户名 </label> -->
            ...
            <el-form-item class="lowin-group password-group" prop="password" label="密码">
              <!-- <label>密码</label> -->
            ...
            <el-form-item class="lowin-group" label="年级">
              <!-- <label>年级 </label> -->
    ...
    <div class="account-foot-copyright">
      <span>Copyright ©2021-2022 Lorem ipsum dolor, sit amet 有限公司 版权所有</span>
    </div>
  </div>
</template>
